...
4. **[`plans/pivot-execution.md`](plans/pivot-execution.md)** — *(added in the next planning session)* the plan that builds the new Supabase+Drizzle CRUD layer, edit forms, seed migration, and reduces alert rules to the locked 4.
