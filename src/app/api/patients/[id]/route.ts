  ...
  return {
    ...
    gestante: p.gestantes
      ? {
          ...
          trHepBHepCPrimeiroTri: p.gestantes.trHepBHepCPrimeiroTri,
          trSifHivTerceiroTri: p.gestantes.trSifHivTerceiroTri,
          puerperioConsulta: p.gestantes.puerperioConsulta,
          puerperioVisitaDomiciliar: p.gestantes.puerperioVisitaDomiciliar,
          puerperioAvaliacaoOdonto: p.gestantes.puerperioAvaliacaoOdonto,
    ...
    tuberculose: p.tuberculose
      ? {
          ...
          ppdMm: p.tuberculose.ppdMm,
          histopatologia: p.tuberculose.histopatologia,
          rxTorax: p.tuberculose.rxTorax,
          formaTratamento: p.tuberculose.formaTratamento,
          contatosCoabitantes: p.tuberculose.contatosCoabitantes,
          contatosExaminados: p.tuberculose.contatosExaminados,
          todosContatosExaminados: p.tuberculose.todosContatosExaminados,
